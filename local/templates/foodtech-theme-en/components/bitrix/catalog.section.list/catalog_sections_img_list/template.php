		...
		case 'TILE':
			foreach ($arResult['SECTIONS'] as &$arSection)
			{
				...
				?>
                    ...
                    <div class="col-lg-4" id="<? echo $this->GetEditAreaId($arSection['ID']); ?>">
                        <div class="card mb-4">
                            <div class="card-bg" style="background-image: url(<? echo $arSection['PICTURE']['SRC']; ?>);"></div>
                            <div class="card-body">
                                ...
                                <a href="<?= $arSection['SECTION_PAGE_URL']; ?>" class="read-more text-color-primary font-weight-semibold text-2">в каталог <i class="fas fa-angle-right position-relative top-1 ms-1"></i></a>
                            </div>
                        </div>
                    </div>
