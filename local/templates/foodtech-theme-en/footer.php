    ...
    <div class="container mb-5-5 mt-5-5">
        <div class="row">
            <div class="col-lg-12">
                ...
                <h2 class="font-weight-semibold">Как мы работаем</h2>
                    ...
                    <div class="col-md-6 col-lg-3 mb-5 mb-lg-0 appear-animation" data-appear-animation="fadeInUpShorter"
                        ...
                        <div class="card border-radius-0 bg-color-light border-0 box-shadow-1">
                            <div class="card-body">
                                ...
                                <p class="card-text">Создаем проект индивидуального решения для Вашего производства</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-3 mb-5 mb-lg-0 appear-animation" data-appear-animation="fadeInUpShorter"
                        ...
                        <div class="card border-radius-0 bg-color-light border-0 box-shadow-1">
                            <div class="card-body">
                                ...
                                <p class="card-text">Обеспечение безупречной работы и сопровождение по эксплуатации</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-6 col-lg-3 mb-4 mb-lg-0">
                ...
                <div>
                    <ul class="list list-icons list-primary">
                        <li>
                            <i class="fas fa-check"></i> <a about="_blank"
                ...
                <div class="contact-details">
                    ...
                    <ul class="list list-icons list-icons-lg">
                        ...
                        <li class="mb-1"><i class="fab fa-whatsapp text-color-primary"></i>
                            <p class="m-0"><a href="tel:+74722735050">+7 (4722) 73-50-50</a></p></li>
