...
?>
    ...
    <div role="main" class="main shop pt-4">
        ...
        <section
                ...
                data-image-src="<?= DEFAULT_TEMPLATE_PATH ?>/images/bg/bg-equipment.webp">
            <div class="container">
                <div class="row">
                    <div class="col-md-8 order-2 order-md-1 align-self-center p-static">
                        <h1>Оборудование компании <strong>Foodtech</strong></h1>
                    </div>
            ...
            <div class="row">
                <? $APPLICATION->IncludeComponent(
                    ...
                    array(
                        ...
                        "CACHE_TYPE" => "N",
                        "CHECK_DATES" => "Y",
                        "COMPONENT_TEMPLATE" => "news_equipment",
